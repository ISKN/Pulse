...
{    
	...
	float noiseAmntX = noise( vec2(-timeValX + pos.x / 1000.0, 100.0), 2.0 );
	float noiseAmntY = noise( vec2(timeValY + pos.y / 1000.0, pos.x / 2000.0), 2.0 );
	...
	if( len < maxLen && len > 0.0  ){
		...
		pos.x += d.x * pct * repulsion;
		pos.y += d.y * pct * repulsion;
	}
